...
| `docs/images/esp-mirror-card-keypad-options.png` | Screenshot | Expanded ESP mirror keypad and endpoint options | Captured: real `v2026.7.1` card with keypad, Auto Answer, DND, extension and group controls visible together |
