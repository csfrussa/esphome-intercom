...
The next release is a major SIP/VoIP migration. If you are using the stable
...
This migration is intentionally breaking. Custom YAMLs from older releases
should be rebuilt from the maintained `dev` YAMLs before the release lands on
`main`.
