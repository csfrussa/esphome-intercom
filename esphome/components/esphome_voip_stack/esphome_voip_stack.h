...
/// SIP phone exposed through the historical `esphome_voip_stack` component name.
///
...
/// See README.md.
class ESPHomeVoipStack : public Component {
 public:
 ...
 protected:
  ...
  // through esphome_voip_stack.set_ha_peer_name for default dial-plan selection.
...
class ESPHomeVoipStackSwitch : public switch_::Switch, public Parented<ESPHomeVoipStack> {
 public:
...
class ESPHomeVoipStackVolume : public number::Number, public Parented<ESPHomeVoipStack> {
 public:
...
class ESPHomeVoipStackMicGain : public number::Number, public Parented<ESPHomeVoipStack> {
 public:
  void control(float value) override {
    if (value != value) value = 0.0f;
...
class ESPHomeVoipStackAutoAnswer : public switch_::Switch, public Parented<ESPHomeVoipStack> {
 public:
  void write_state(bool state) override {
...
class ESPHomeVoipStackDndSwitch : public switch_::Switch, public Parented<ESPHomeVoipStack> {
 public:
  void write_state(bool state) override {
...
class VoipCallButton : public button::Button, public Parented<ESPHomeVoipStack> {
 protected:
  void press_action() override { this->parent_->call_toggle(); }
};

class VoipNextContactButton : public button::Button, public Parented<ESPHomeVoipStack> {
 protected:
  void press_action() override { this->parent_->next_contact(); }
};

class VoipPreviousContactButton : public button::Button, public Parented<ESPHomeVoipStack> {
 protected:
  void press_action() override { this->parent_->prev_contact(); }
};

class VoipDeclineButton : public button::Button, public Parented<ESPHomeVoipStack> {
 protected:
...
// because actions.h re-opens it and needs the full ESPHomeVoipStack type.
#include "actions.h"
