...
// Action / Condition templates for esphome_voip_stack YAML automation.
// esphome_voip_stack.h re-includes this at the bottom; pragma once handles the loop.
...
class NextContactAction : public Action<Ts...>, public Parented<ESPHomeVoipStack> {
 public:
  void play(const Ts &...x) override { this->parent_->next_contact(); }
};

template<typename... Ts>
class PrevContactAction : public Action<Ts...>, public Parented<ESPHomeVoipStack> {
 public:
  void play(const Ts &...x) override { this->parent_->prev_contact(); }
};

template<typename... Ts>
class StartAction : public Action<Ts...>, public Parented<ESPHomeVoipStack> {
 public:
  void play(const Ts &...x) override { this->parent_->start(); }
};
template<typename... Ts>
class StopAction : public Action<Ts...>, public Parented<ESPHomeVoipStack> {
 public:
  void play(const Ts &...x) override { this->parent_->stop(); }
};

template<typename... Ts>
class AnswerCallAction : public Action<Ts...>, public Parented<ESPHomeVoipStack> {
 public:
  void play(const Ts &...x) override { this->parent_->answer_call(); }
};

template<typename... Ts>
class DeclineCallAction : public Action<Ts...>, public Parented<ESPHomeVoipStack> {
 public:
...
template<typename... Ts>
class SetVolumeAction : public Action<Ts...>, public Parented<ESPHomeVoipStack> {
 public:
...
template<typename... Ts>
class SetMicGainDbAction : public Action<Ts...>, public Parented<ESPHomeVoipStack> {
 public:
...
template<typename... Ts>
class SetContactsAction : public Action<Ts...>, public Parented<ESPHomeVoipStack> {
 public:
...
template<typename... Ts>
class SetContactAction : public Action<Ts...>, public Parented<ESPHomeVoipStack> {
 public:
...
template<typename... Ts>
class CallContactAction : public Action<Ts...>, public Parented<ESPHomeVoipStack> {
 public:
  TEMPLATABLE_VALUE(std::string, contact)
  void play(const Ts &...x) override {
...
template<typename... Ts>
class CallToggleAction : public Action<Ts...>, public Parented<ESPHomeVoipStack> {
 public:
  void play(const Ts &...x) override { this->parent_->call_toggle(); }
};

template<typename... Ts>
class FlushContactsAction : public Action<Ts...>, public Parented<ESPHomeVoipStack> {
 public:
  void play(const Ts &...x) override { this->parent_->flush_contacts(); }
};

template<typename... Ts>
class UpdateContactsAction : public Action<Ts...>, public Parented<ESPHomeVoipStack> {
 public:
  void play(const Ts &...x) override { this->parent_->update_contacts(); }
};

template<typename... Ts>
class AddContactAction : public Action<Ts...>, public Parented<ESPHomeVoipStack> {
 public:
...
template<typename... Ts>
class RemoveContactAction : public Action<Ts...>, public Parented<ESPHomeVoipStack> {
 public:
  TEMPLATABLE_VALUE(std::string, entry)
  void play(const Ts &...x) override {
...
template<typename... Ts>
class SetHaPeerNameAction : public Action<Ts...>, public Parented<ESPHomeVoipStack> {
 public:
  TEMPLATABLE_VALUE(std::string, name)
  void play(const Ts &...x) override {
...
template<typename... Ts>
class SetRemoteEndpointAction : public Action<Ts...>, public Parented<ESPHomeVoipStack> {
 public:
  TEMPLATABLE_VALUE(std::string, ip)
  TEMPLATABLE_VALUE(uint16_t, port)
  TEMPLATABLE_VALUE(uint16_t, rtp_port)
...
template<typename... Ts>
class PublishEntityStatesAction : public Action<Ts...>, public Parented<ESPHomeVoipStack> {
 public:
  void play(const Ts &...x) override { this->parent_->publish_entity_states(); }
};

template<typename... Ts>
class VoipIsIdleCondition : public Condition<Ts...>, public Parented<ESPHomeVoipStack> {
 public:
  bool check(const Ts &...x) override { return this->parent_->is_idle(); }
};

template<typename... Ts>
class VoipIsRingingCondition : public Condition<Ts...>, public Parented<ESPHomeVoipStack> {
 public:
  bool check(const Ts &...x) override { return this->parent_->is_ringing(); }
};

template<typename... Ts>
class VoipIsInCallCondition : public Condition<Ts...>, public Parented<ESPHomeVoipStack> {
 public:
  bool check(const Ts &...x) override { return this->parent_->is_in_call(); }
};

template<typename... Ts>
class VoipIsCallingCondition : public Condition<Ts...>, public Parented<ESPHomeVoipStack> {
 public:
  bool check(const Ts &...x) override { return this->parent_->get_call_state() == CallState::CALLING; }
};

template<typename... Ts>
class VoipIsIncomingCondition : public Condition<Ts...>, public Parented<ESPHomeVoipStack> {
 public:
...
template<typename... Ts>
class VoipDestinationIsCondition : public Condition<Ts...>, public Parented<ESPHomeVoipStack> {
 public:
...
template<typename... Ts>
class VoipIsHaDestinationCondition : public Condition<Ts...>, public Parented<ESPHomeVoipStack> {
 public:
