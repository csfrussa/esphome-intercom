"""Constants for Home Assistant VoIP Stack integration."""
...
URL_BASE = "/homeassistant-voip-stack"
HA_PEER_FALLBACK_NAME = "homeassistant-voip-stack"
HA_SOFTPHONE_DEVICE_ID = "__homeassistant_voip_stack_ha_softphone__"
