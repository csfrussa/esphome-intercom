...
async def async_setup_entry(
    ...
    unified_sensor = IntercomPhonebookSensor(hass)
...
class IntercomPhonebookSensor(SensorEntity):
    ...
    async def async_added_to_hass(self) -> None:
        ...
        def _on_registry_change(event) -> None:
            ...
            if "intercom_state" not in entity_id and "intercom_endpoint" not in entity_id:
                return
    ...
    async def _refresh_tracked_entities(self, initial: bool = False) -> None:
        ...
        new_set = {
            ...
            if "intercom_state" in e.entity_id or "intercom_endpoint" in e.entity_id
        }
