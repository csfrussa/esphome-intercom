...
class IntercomNativeConfigFlow(ConfigFlow, domain=DOMAIN):
    ...
    def _store_entry(self, data: dict):
        ...
        return self.async_create_entry(title="Intercom Native", data=data)
                ...
                data.update(
                    {
                        ...
                        CONF_TRUNK_SERVER: "",
                        CONF_TRUNK_PORT: INTERCOM_SIP_PORT,
                        CONF_TRUNK_DOMAIN: "",
                        CONF_TRUNK_USERNAME: "",
                        CONF_TRUNK_AUTH_USERNAME: "",
                        CONF_TRUNK_PASSWORD: "",
    ...
    async def async_step_trunk(self, user_input=None):
        ...
        defaults = {
            ...
            CONF_TRUNK_PORT: existing.get(CONF_TRUNK_PORT, INTERCOM_SIP_PORT),
            ...
            if not errors:
                data = dict(
                    ...
                    or {
                        CONF_SIP_TCP_ENABLED: existing.get(CONF_SIP_TCP_ENABLED, True),
                        CONF_SIP_UDP_ENABLED: existing.get(CONF_SIP_UDP_ENABLED, False),
                        "sip_port": int(existing.get("sip_port", INTERCOM_SIP_PORT)),
